...
bool Shader::loadShader(unsigned int stage, const char* filename) {
	...
	switch (stage) {
	case (unsigned int)eShaderStage::VERTEX:	m_handle = glCreateShader(GL_VERTEX_SHADER);	break;
	case (unsigned int)eShaderStage::TESSELLATION_EVALUATION:	m_handle = glCreateShader(GL_TESS_EVALUATION_SHADER);	break;
	case (unsigned int)eShaderStage::TESSELLATION_CONTROL:	m_handle = glCreateShader(GL_TESS_CONTROL_SHADER);	break;
	case (unsigned int)eShaderStage::GEOMETRY:	m_handle = glCreateShader(GL_GEOMETRY_SHADER);	break;
	case (unsigned int)eShaderStage::FRAGMENT:	m_handle = glCreateShader(GL_FRAGMENT_SHADER);	break;
	default:	break;
	};
...
bool Shader::createShader(unsigned int stage, const char* string) {
	...
	switch (stage) {
	case (int)eShaderStage::VERTEX:	m_handle = glCreateShader(GL_VERTEX_SHADER);	break;
	case (int)eShaderStage::TESSELLATION_EVALUATION:	m_handle = glCreateShader(GL_TESS_EVALUATION_SHADER);	break;
	case (int)eShaderStage::TESSELLATION_CONTROL:	m_handle = glCreateShader(GL_TESS_CONTROL_SHADER);	break;
	case (int)eShaderStage::GEOMETRY:	m_handle = glCreateShader(GL_GEOMETRY_SHADER);	break;
	case (int)eShaderStage::FRAGMENT:	m_handle = glCreateShader(GL_FRAGMENT_SHADER);	break;
	default:	break;
	};
